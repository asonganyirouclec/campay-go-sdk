...
import (
	...
	models "github.com/Iknite-Space/campay-go-sdk/internal/models"
...
func (m *MockPaymentService) InitiatePayments(ctx context.Context, req models.RequestBody) error {
	m.ctrl.T.Helper()
