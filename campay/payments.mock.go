...
// Package campay is a generated GoMock package.
package campay
...
func (m *MockPaymentService) InitiatePayments(ctx context.Context, req RequestBody) (*ResponseBody, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitiatePayments", ctx, req)
	ret0, _ := ret[0].(*ResponseBody)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
